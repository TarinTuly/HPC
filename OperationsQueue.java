...
public class OperationsQueue {
    ...
    public void addSimulation(int totalSimulation) {
        ...
        for (int i = 0; i < totalSimulation; i++) {
            ...
            if (random != 0) {
               synchronized (this) {  // Synchronize access to the operations list
        ...
        synchronized (this) {  // Synchronize adding the termination signal
            operations.add(-9999);
        }
    }
    public synchronized void add(int amount) {  // Synchronized method to ensure thread safety
